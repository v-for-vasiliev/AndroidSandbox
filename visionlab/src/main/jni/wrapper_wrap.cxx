...
/*SWIGEXPORT void JNICALL Java_ru_visionlab_faceengine_FaceEngineJNI_ImageView_1pixels_1set(JNIEnv *jenv,
                                                                                                      jclass jcls,
                                                                                                      jlong jarg1,
                                                                                                      jobject jarg1_,
                                                                                                      jobject jarg2)
...
SWIGEXPORT jfloatArray JNICALL Java_ru_visionlab_faceengine_FaceEngineJNI_PhotoMaker_1getScores(
        JNIEnv *jenv,
        jclass jcls,
        jlong jarg1,
        jobject jarg1_) {
...
SWIGEXPORT jboolean JNICALL Java_ru_visionlab_faceengine_FaceEngineJNI_PhotoMaker_1primaryDetectionChanged(
        ...
        jobject jarg1_)
{
    LOG_INFO("[FRONTAL POSE]","WrapperJNI_primaryDetectionChanged\n");
    jboolean jresult = 0;
    vl::PhotoMaker *arg1;
    bool result;
    ...
    LOG_INFO("[FRONTAL POSE]","WrapperJNI_primaryDetectionChanged = %d\n",result);
    jresult = (jboolean) result;
    return jresult;
}
