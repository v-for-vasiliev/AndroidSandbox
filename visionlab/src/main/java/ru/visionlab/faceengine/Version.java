...
public final class Version {
    ...
    public final static Version VERSION_MAJOR = new Version("VERSION_MAJOR",
            FaceEngineJNI.VERSION_MAJOR_get());

    public final static Version VERSION_MINOR = new Version("VERSION_MINOR",
            FaceEngineJNI.VERSION_MINOR_get());

    public final static Version VERSION_PATCH = new Version("VERSION_PATCH",
            FaceEngineJNI.VERSION_PATCH_get());
